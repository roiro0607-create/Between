...
export default function EventMatchingApp() {
  ...
  const MarbleBackground = () => (
    <div style={{
      ...
      zIndex: -2,
      background: `
        radial-gradient(ellipse at 15% 20%, #4a6fa5 0%, transparent 45%),
        radial-gradient(ellipse at 85% 80%, #be896f 0%, transparent 45%),
        radial-gradient(ellipse at 25% 65%, #6a8db5 0%, transparent 40%),
        radial-gradient(ellipse at 75% 35%, #D9CFC1 0%, transparent 38%),
        radial-gradient(ellipse at 50% 50%, #8fa5b0 0%, transparent 30%),
        radial-gradient(ellipse at 40% 85%, #c4a68a 0%, transparent 35%),
        radial-gradient(ellipse at 65% 15%, #5b7c99 0%, transparent 33%),
        radial-gradient(ellipse at 10% 90%, #a89884 0%, transparent 28%),
        radial-gradient(ellipse at 90% 10%, #b3a08f 0%, transparent 30%),
        linear-gradient(135deg, #4a6fa5 0%, #7a8faa 30%, #a89884 70%, #be896f 100%)
      `
    }} />
  );
  ...
  return (
    <div className="min-h-screen p-4" style={{fontFamily: "'Noto Sans JP', sans-serif"}}>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-6 pt-4">
          ...
          <div className="flex-1 flex justify-end gap-3">
            ...
            <button
              ...
              className="lg:hidden p-2 rounded-xl hover:opacity-90 transition-all relative"
              style={{
            ...
            {currentUser ? (
              <button
                onClick={onProfile}
                className="hidden lg:flex rounded-full hover:opacity-90 transition-all cursor-pointer"
                style={{
                  backgroundColor: 'rgba(255, 255, 255, 0.2)',
                  border: '1px solid rgba(255, 255, 255, 0.3)',
                  padding: '2px'
              ...
              <>
                <button
                  onClick={onLogin}
                  className="hidden lg:block px-4 py-2 rounded-xl font-medium hover:opacity-90 transition-all"
                  style={{
                    backgroundColor: 'rgba(255, 255, 255, 0.2)',
                    color: '#FFFFFF',
                    border: '1px solid rgba(255, 255, 255, 0.3)'
        ...
        {/* SP版: モバイルメニュー */}
        {isMobileMenuOpen && (
          <div className="lg:hidden mb-6 rounded-2xl overflow-hidden shadow-lg" style={{
            backgroundColor: 'rgba(255, 255, 255, 0.25)',
